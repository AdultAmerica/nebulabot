...
HELP = {
    ...
    "buttons": (
        ...
        "<b>Where the buttons land.</b>\n\n"
        "• <b>One photo or video</b> — caption and buttons ride on it. A "
        "single self-contained post, nothing trailing.\n"
        "• <b>Several items</b> — the album goes out whole and the bot then "
        "tries to attach the keyboard to the album itself. If Telegram allows "
        "it, that is one post; if not, the caption and buttons follow in a "
        "message underneath and the bot stops trying.\n\n"
        "<code>/health</code> reports which of those applies. The 🔘 "
        "<b>Buttons</b> option can also force the keyboard onto the first "
        "item, splitting it off from the album."
    ),
    "schedule": (
        "⏱ <b>Scheduling</b>\n\n"
        "Four modes:\n"
